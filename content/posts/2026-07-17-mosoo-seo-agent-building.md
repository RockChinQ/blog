...
![](/images/Screenshot%202026-07-20%20at%202.00.24%20PM.png)

当然，mosoo 也是[开源](https://github.com/langgenius/mosoo)的，可以让你的 Coding Agent 克隆到本地，再让他帮你启动～

#### 开始 Cook

![](/images/Screenshot%202026-07-20%20at%202.00.52%20PM.png)

在 Agents 页面创建一个新的 Agent，然后就自动进入了编辑器（看着很直观是吧）；我们选择使用 OpenAI Runtime，也就是 Codex，这将在 Mosoo 的沙盒里启动一个 Codex 实例，并且通过 ACP 受到控制；对应的，我们选择使用与 Codex 配合的 gpt-5.6-sol 模型；![](/images/Screenshot%202026-07-20%20at%202.01.47%20PM.png)
...
![](/images/Screenshot%202026-07-20%20at%202.02.57%20PM.png)

现在回到刚刚创建的那个 Agent 的页面，选择这几个 skills。最终的配置如图所示：
![](/images/Screenshot%202026-07-20%20at%202.03.34%20PM.png)

#### 开始测试

点击 Agent 右上角的 publish，然后在弹出窗里即可进入测试页面：（也可以从左侧的 Run 进入测试页面）![](/images/Screenshot%202026-07-20%20at%202.04.34%20PM.png)

首次运行需要等待沙盒和其中的 Agent 启动。经过一段时间的执行之后，任务完成了，可以点击查看生成的文章文件。

![](/images/Screenshot%202026-07-20%20at%202.37.09%20PM.png)

前往 Files 查看和下载刚刚 Agent 生成的文章原文件：

![](/images/Screenshot%202026-07-20%20at%202.40.36%20PM.png)
